...
function setupThree() {
  ...
  // FBX Loading disabled due to incompatible file versions (FileVersion 6100).
  // createObstacleMesh and createPropMesh have procedural fallbacks that will be used instead.
  /*
  const loader = new FBXLoader();
  const fbxList = [
    {
      name: "raider",
      path: "/models/raider.fbx",
      scale: 0.007,
      rotationY: Math.PI,
      color: "#4d3a2e",
      metalness: 0.5,
